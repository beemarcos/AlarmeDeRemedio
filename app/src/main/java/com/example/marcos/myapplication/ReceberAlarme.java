...
public class ReceberAlarme extends BroadcastReceiver{
    ...
    public void onReceive(Context context, Intent intent){
        ...
        repeating_intent.putExtra("tipodosemedicamento",intent.getExtras().getString("tipodosemedicamento"));
        repeating_intent.putExtra("tempomedicamento",intent.getExtras().getString("tempomedicamento"));
        repeating_intent.putExtra("dosemedicamento",intent.getExtras().getString("dosemedicamento"));
        repeating_intent.putExtra("quantidademedicamento",intent.getExtras().getString("quantidademedicamento"));
